...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var pc_preset = localStorage.getItem('pc-preset');
    if (pc_preset != null) {
        preset_change(pc_preset);
    } else {
    ...
    if (dark_layout == "default") {
        if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches && localStorage.getItem('pc-theme') == null) {
            dark_layout = 'true';
        } else {
            dark_layout = 'false';
        }
    ...
    if (dark_layout == 'true') {
        layout_change(localStorage.getItem('pc-theme'));
    } else {
        layout_change(localStorage.getItem('pc-theme'));
    }
...
function preset_change(value) {
    ...
    var test = localStorage.setItem('pc-preset', value);
